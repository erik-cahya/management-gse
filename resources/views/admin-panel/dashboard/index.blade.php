...
@section('content')
    <div class="content">
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="">
                                    ...
                                    <p class="text-muted mb-4">
                                        <span class="badge bg-success-subtle text-success"><i class="bi bi-graph-up-arrow me-1"></i> 11.8%</span>
                                        vs last month
                                    </p>
                                </div>
                                <div class="avatar-sm mb-4">
            ...
            <div class="row">
                <div class="col-lg-4 order-lg-1 order-2">
                    <div class="card">
                        ...
                        <div class="card-body my-3 py-0" data-simplebar style="max-height: 470px;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-danger border bg-transparent">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Dribbble <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="fs-16 text-dark text-end"><i class="bi bi-arrow-right"></i></a>
                            </div><!-- end flex -->

                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-info border bg-transparent">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16" fill="currentColor" id="twitter">
                                                <path
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-info h3 my-0 border bg-transparent">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Behance
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-primary h3 my-0 border bg-transparent">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Facebook <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="fs-16 text-dark text-end"><i class="bi bi-arrow-right"></i></a>
                            </div><!-- end flex -->
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-danger h3 my-0 border bg-transparent">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Instagram <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="fs-16 text-dark text-end"><i class="bi bi-arrow-right"></i></a>
                            </div><!-- end flex -->
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-dark h3 my-0 border bg-transparent">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Github
                                        <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="fs-16 text-dark text-end"><i class="bi bi-arrow-right"></i></a>
                            </div><!-- end flex -->
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm rounded">
                                        <span class="avatar-title border-light text-success h3 my-0 border bg-transparent">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Google
                                        <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="fs-16 text-dark text-end"><i class="bi bi-arrow-right"></i></a>
                            </div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <a href="javascript:void(0);" class="h4 fw-semibold text-reset my-0">Pinterest <i class="mdi mdi-check-decagram text-muted ms-1"></i></a>
                                </div>
                                <a href="javascript:void(0);" class="fs-16 text-dark text-end"><i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xxl-4 order-lg-2 order-1">
                    <div class="card">
                            ...
                            <div class="timeline-alt p-3">
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="javascript:void(0);" class="text-info fw-bold d-block mb-1">You sold an item</a>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="javascript:void(0);" class="text-primary fw-bold d-block mb-1">Product on the
                                            Bootstrap Market</a>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="javascript:void(0);" class="text-info fw-bold d-block mb-1">Robert Delaney</a>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-item-info">
                                        <a href="javascript:void(0);" class="text-primary fw-bold d-block mb-1">Audrey Tobey</a>
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="">
                                <a class="btn btn-outline-secondary me-2">
                                    <i class="mdi mdi-filter-outline lh-1 pe-1"></i>Filter
                                </a>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm">
                                                        <img src="{{ asset('admin') }}/assets/images/users/avatar-9.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div class="ps-2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-2">
                                                        <h5 class="text-capitalize mb-1">Floyd Smith</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="text-capitalize mb-0">Arlene Mccoy</h5>
                                            </td>
                                            <td>
                                                <span class="badge bg-primary-subtle text-primary">Pending
                                                    Approval</span>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar-sm">
                                                        <img src="{{ asset('admin') }}/assets/images/users/avatar-11.jpg" alt="" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div class="ps-2">
