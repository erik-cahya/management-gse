                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('perusahaan_id') is-invalid @enderror" data-toggle="select2" id="perusahaan_id" name="perusahaan_id">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('type_peralatan_gse') is-invalid @enderror" data-toggle="select2" id="type_peralatan_gse" name="type_peralatan_gse">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="merk" class="form-control @error('merk') is-invalid @enderror" name="merk" placeholder="Masukkan Nomor Plat/Nopol Kendaraan" value="{{ old('merk') }}">
                                            @error('merk')
                                                <div class="invalid-feedback" bis_skin_checked="1">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('kategori') is-invalid @enderror" data-toggle="select2" id="kategori" name="kategori">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('bahan_bakar') is-invalid @enderror" data-toggle="select2" id="bahan_bakar" name="bahan_bakar">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="panjang" class="form-control @error('panjang') is-invalid @enderror" name="panjang" placeholder="Masukkan Nomor Plat/Nopol Kendaraan" value="{{ old('panjang') }}">
                                            @error('panjang')
                                                <div class="invalid-feedback" bis_skin_checked="1">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="lebar" class="form-control @error('lebar') is-invalid @enderror" name="lebar" placeholder="Masukkan Nomor Plat/Nopol Kendaraan" value="{{ old('lebar') }}">
                                            @error('lebar')
                                                <div class="invalid-feedback" bis_skin_checked="1">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="luas" class="form-control @error('luas') is-invalid @enderror" name="luas" placeholder="Masukkan Nomor Plat/Nopol Kendaraan" value="{{ old('luas') }}">
                                            @error('luas')
                                                <div class="invalid-feedback" bis_skin_checked="1">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="manufacture_year" class="form-control @error('manufacture_year') is-invalid @enderror" name="manufacture_year" placeholder="Masukkan Nomor Plat/Nopol Kendaraan" value="{{ old('manufacture_year') }}">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('status_kepemilikan') is-invalid @enderror" data-toggle="select2" id="status_kepemilikan" name="status_kepemilikan">
                                    ...
                                    <div class="col-lg-1">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('kode_gh') is-invalid @enderror" data-toggle="select2" id="kode_gh" name="kode_gh">
                                    ...
                                    <div class="col-lg-1">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('kode_gse') is-invalid @enderror" data-toggle="select2" id="kode_gse" name="kode_gse">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-select @error('status_gse') is-invalid @enderror" data-toggle="select2" id="status_gse" name="status">
