                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form enctype="multipart/form-data" method="POST" action="{{ route('gse.update', $dataGse->gse_id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="gse_serial" class="form-control @error('gse_serial') is-invalid @enderror" name="gse_serial" placeholder="Masukkan Nomor Sticker GSE" value="{{ old('gse_serial', $dataGse->gse_serial) }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="nomor_asset" class="form-control @error('nomor_asset') is-invalid @enderror" name="nomor_asset" placeholder="Masukkan Nomor Sticker GSE" value="{{ old('nomor_asset', $dataGse->nomor_asset) }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="nopol_kendaraan" class="form-control @error('nopol_kendaraan') is-invalid @enderror" name="nopol_kendaraan" placeholder="Masukkan Nomor Plat/Nopol Kendaraan" value="{{ old('nopol_kendaraan', $dataGse->nopol_kendaraan) }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('perusahaan_id') is-invalid @enderror form-select" data-toggle="select2" id="perusahaan_id" name="perusahaan_id">
                                                        ...
                                                        @foreach ($dataPerusahaan as $perusahaan)
                                                            <option value="{{ $perusahaan->perusahaan_id }}" {{ old('perusahaan_id', $dataGse->perusahaan_id) == $dataGse->perusahaan_id ? 'selected' : '' }}>{{ $perusahaan->nama_perusahaan }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('perusahaan_id')
                                                        <div class="invalid-feedback" bis_skin_checked="1">{{ $message }}</div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('type_peralatan_gse') is-invalid @enderror form-select" data-toggle="select2" id="type_peralatan_gse" name="type_peralatan_gse">
                                                        ...
                                                        @foreach ($typePeralatan as $peralatan)
                                                            <option value="{{ $peralatan->peralatan_id }}" {{ old('type_peralatan_gse', $dataGse->type_peralatan_gse) == $peralatan->peralatan_id ? 'selected' : '' }}>{{ $peralatan->nama_peralatan }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="merk" class="form-control @error('merk') is-invalid @enderror" name="merk" placeholder="Masukkan Merk Kendaraan" value="{{ old('merk', $dataGse->merk) }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('kategori') is-invalid @enderror form-select" data-toggle="select2" id="kategori" name="kategori">
                                                        ...
                                                        @foreach ($dataKategori as $kategori)
                                                            <option value="{{ $kategori->kategori_id }}" {{ old('kategori', $dataGse->id_kategori) == $kategori->kategori_id ? 'selected' : '' }}>{{ $kategori->nama_kategori }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('kategori')
                                                        <div class="invalid-feedback" bis_skin_checked="1">{{ $message }}</div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('bahan_bakar') is-invalid @enderror form-select" data-toggle="select2" id="bahan_bakar" name="bahan_bakar">
                                                        ...
                                                        @foreach ($dataBahanBakar as $bahan_bakar)
                                                            <option value="{{ $bahan_bakar->bahan_bakar_id }}" {{ old('bahan_bakar', $dataGse->bahan_bakar) == $bahan_bakar->bahan_bakar_id ? 'selected' : '' }}>{{ $bahan_bakar->nama_bahan_bakar }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('bahan_bakar')
                                                        <div class="invalid-feedback" bis_skin_checked="1">{{ $message }}</div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="panjang" class="form-control @error('panjang') is-invalid @enderror" name="panjang" placeholder="Masukkan Ukuran Panjang Kendaraan" value="{{ old('panjang', $dataGse->panjang) }}">
                                                    @error('panjang')
                                                        <div class="invalid-feedback" bis_skin_checked="1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="lebar" class="form-control @error('lebar') is-invalid @enderror" name="lebar" placeholder="Masukkan Ukuran Lebar Kendaraan" value="{{ old('lebar', $dataGse->lebar) }}">
                                                    @error('lebar')
                                                        <div class="invalid-feedback" bis_skin_checked="1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="luas" class="form-control @error('luas') is-invalid @enderror" name="luas" placeholder="Masukkan Ukuran Luas Kendaraan" value="{{ old('luas', $dataGse->luas) }}">
                                                    @error('luas')
                                                        <div class="invalid-feedback" bis_skin_checked="1">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" id="manufacture_year" class="form-control @error('manufacture_year') is-invalid @enderror" name="manufacture_year" placeholder="Masukkan Tahun Manufaktur Kendaraan" value="{{ old('manufacture_year', $dataGse->manufacture_year) }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('status_kepemilikan') is-invalid @enderror form-select" data-toggle="select2" id="status_kepemilikan" name="status_kepemilikan">
                                                        ...
                                                        @foreach ($dataStatusKepemilikan as $status_kepemilikan)
                                                            <option value="{{ $status_kepemilikan->kepemilikan_id }}" {{ old('status_kepemilikan', $dataGse->status_kepemilikan) == $status_kepemilikan->kepemilikan_id ? 'selected' : '' }}>{{ $status_kepemilikan->nama_kepemilikan }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="perusahaan_sewa" class="form-control @error('perusahaan_sewa') is-invalid @enderror" name="perusahaan_sewa" placeholder="Masukkan nama perusahaan sewa" value="{{ old('perusahaan_sewa', $dataGse->perusahaan_sewa) }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="status_sewa" class="form-control @error('status_sewa') is-invalid @enderror" name="status_sewa" placeholder="Masukkan status sewa" value="{{ old('status_sewa', $dataGse->status_sewa) }}">
                                                    @error('status_sewa')
                                                        <div class="invalid-feedback" bis_skin_checked="1">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" id="tanggal_sewa" class="form-control @error('tanggal_sewa') is-invalid @enderror" name="tanggal_sewa" placeholder="Masukkan tanggal sewa" value="{{ old('tanggal_sewa', $dataGse->tanggal_sewa) }}">
                                                    @error('tanggal_sewa')
                                                        <div class="invalid-feedback" bis_skin_checked="1">
                                                            {{ $message }}
                                                        </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('kode_gh') is-invalid @enderror form-select" data-toggle="select2" id="kode_gh" name="kode_gh">
                                                        ...
                                                        @foreach ($dataKodeGH as $kode_gh)
                                                            <option value="{{ $kode_gh->kode_gh_id }}" {{ old('kode_gh', $dataGse->kode_gh) == $kode_gh->kode_gh_id ? 'selected' : '' }}>{{ $kode_gh->kode_gh }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('kode_gh')
                                                        <div class="invalid-feedback" bis_skin_checked="1">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select2 @error('kode_gse') is-invalid @enderror form-select" data-toggle="select2" id="kode_gse" name="kode_gse">
                                                        ...
                                                        @foreach ($dataKodeGSE as $kode_gse)
                                                            <option value="{{ $kode_gse->kode_gse_id }}" {{ old('kode_gse', $dataGse->kode_gse) == $kode_gse->kode_gse_id ? 'selected' : '' }}>{{ $kode_gse->kode_gse }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('kode_gse')
                                                        <div class="invalid-feedback" bis_skin_checked="1">
